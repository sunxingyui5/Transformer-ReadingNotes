...
> encoder将一个长为n的输入（如句子）：![](http://latex.codecogs.com/svg.latex?X=x_1,x_2,...,x_n)映射成![](http://latex.codecogs.com/svg.latex?Z=z_1,z_2,...,z_n)，输入![](http://latex.codecogs.com/svg.latex?x_t)对应机器学习可以理解的向量![](http://latex.codecogs.com/svg.latex?z_t) 
